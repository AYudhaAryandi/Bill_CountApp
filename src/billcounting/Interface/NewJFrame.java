...
import static billcounting.Interface.Koneksi.getConnection;
...
public class NewJFrame extends javax.swing.JFrame {
 ...
 public void bill_print(){
        ...
        try {
            bill.setText("           Jumlah Total dari semuanya \n");
            ...
            bill.setText(bill.getText() + " ====================\n");
            bill.setText(bill.getText() + "\tThanks >_<...!"+"\n");
...
try {
        ...
        // Ubah query sesuai dengan struktur tabel Anda
        String query = "INSERT INTO counting (item, qty, price) VALUES (?, ?, ?)";
        try (PreparedStatement pst = connection.prepareStatement(query)) {
            DefaultTableModel dfModel = (DefaultTableModel) jTable1.getModel();
            for (int i = 0; i < dfModel.getRowCount(); i++) {
                String item = dfModel.getValueAt(i, 0).toString();
                String qty = dfModel.getValueAt(i, 1).toString();
                String price = dfModel.getValueAt(i, 2).toString();
